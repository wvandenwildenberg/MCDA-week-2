...
from .a_fine_aggregator import a_fine_aggregator
...
class GeneticAlgorithm:
    ...
    def __init__(self, objective, constraints: list, bounds: list, cons_handler: str = 'simple', options: dict = None,
        ...
        assert self.aggregation in [None, 'tetra',
                                    'minmax', 'a-fine'], 'Wrong aggregation, should be tetra, minmax, a-fine, or None (default)'
    ...
    def run(self, verbose: bool = True):
        ...
        elif self.aggregation == 'a-fine':
            best_eval, decoded, best = self._runner(pop, r_count, verbose, aggregation='a-fine')
